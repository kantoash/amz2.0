                ...
                <div className='flex-col flex-grow p-5 space-y-10  bg-white '>
                  <div>
                    ...
                    {items.map((item: any,i: any) => (
                        ...
                        <CheckOutProduct key={i} id={item.id} title={item.title} category={item.category} description={item.description} image={item.image} price={item.price} rating={item.rating} hasPrime={item.hasPrime} />
